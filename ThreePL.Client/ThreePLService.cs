...
namespace ThreePL.Client
{
    public class ThreePLService : IThreePLService
    {
        ...
        public Task<AddressDescription> GetAddressById(string tenantId, string addressId)
        {
            throw new NotImplementedException();
        }

        public Task<List<CargoOwnerDescription>> GetCargoOwner(string tenantId, string customerId)
        {
            throw new NotImplementedException();
        }

        public Task<List<CargoOwnerDescription>> GetCargoOwner(string tenantId)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<List<RouteScheme>> GetRouteScheme(string tenantId)
        {
            throw new NotImplementedException();
        }

        public Task<List<RouteScheme>> GetRouteScheme(string tenantId, string customerId)
        {
            throw new NotImplementedException();
        }

        public Task<RouteScheme> GetRouteSchemeById(string tenantId, string id)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<AddressDescription?> GetWarehouseAddress(string warehouseId)
        {
            throw new NotImplementedException();
        }
        ...
        //public async Task<List<WarehouseDescription>> GetWarehouse(string tenantId, int customerId)
        //{
        //    if (!string.IsNullOrEmpty(tenantId))
        //    {
        //        httpClient.DefaultRequestHeaders.Add("tenant",tenantId);
        //    }
        //    string url = $@"/api/warehouse-management/interfacewarehouse/consigner?ConsignerTripleId=" + customerId;
        //    var res = await httpClient.GetStringAsync(url);
        //    var resp = JsonConvert.DeserializeObject<ListDto<List<SystemWarehouseDto>>>(res);
        //    return resp.Items.Any() ?
        //        resp.Items.Select(r => new WarehouseDescription(r.WarehouseId, r.InterfaceWarehouseId, r.WarehouseName)).ToList() :
        ...
        //public async Task<AddressDescription?> GetWarehouseAddress(int warehouseId)
        //{
        //    var json = await httpClient.GetStringAsync($@"/api/warehouse-management/warehouse/{warehouseId}");
        //    if (string.IsNullOrEmpty(json))
        //        return null;

        //    var res = new JObject(json);
        //    var result = new AddressDescription(
        //        res["province"].Value<string>(),
        //        res["city"].Value<string>(),
        //        res["district"].Value<string>(),
        //        res["address"].Value<string>());
        ...
        //        list.Add(transportPlan);
        //    }
        //    return new DataResult<List<TransportPlanRet>> { Data = list };
        //}
    }
}
